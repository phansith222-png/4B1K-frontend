                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-20">
                    {songs.slice(0, 4).map((item, idx) => (
                        <button 
                            ...
                            className={`border ${currentSongIndex === idx ? 'border-[#D3131F] bg-[#1a0f0f]' : 'border-white/5 bg-[#111111]'} hover:border-[#D3131F]/50 text-white rounded-xl p-5 md:p-6 transition-all duration-300 group flex items-center gap-6 hover:bg-[#1a1112] text-left shadow-lg`}
                        >
