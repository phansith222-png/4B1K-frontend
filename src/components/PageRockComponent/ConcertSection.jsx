        ...
        <section className="relative w-full py-24 px-6 bg-[#0a0a0a] overflow-hidden border-y border-white/5">
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-5 mb-14">
                    ...
                    <button className="flex items-center gap-2 text-[10px] md:text-xs font-bold text-gray-400 hover:text-white uppercase tracking-widest transition-colors mt-4 md:mt-0 group bg-[#111] px-5 py-2.5 rounded border border-white/5">
                        VIEW ALL SHOWS
