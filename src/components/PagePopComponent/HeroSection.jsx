        ...
        <section className="relative w-full min-h-[90vh] flex flex-col justify-center items-center py-20 px-6 overflow-hidden">
            ...
            <div className="relative w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center gap-10 mt-10">
                ...
                >
                    ...
                    {/* Main Image Card */}
                    <div className="relative w-full h-full rounded-[2.5rem] overflow-hidden z-10 border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.8)] bg-[#110E1B] group">
                        <img
                            src={artist.profileImage || "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?q=80&w=2000&auto=format&fit=crop"}
                            alt={artist.artistName}
                            className="absolute inset-0 w-full h-full object-cover opacity-80 mix-blend-screen transition-transform duration-[15s] ease-out group-hover:scale-110"
                        />
                        ...
                        <div className="absolute bottom-12 left-8 md:left-16 z-20">
                            <span className="bg-gradient-to-r from-[#00E5FF]/20 to-[#FF007F]/20 text-white backdrop-blur-md border border-white/20 px-5 py-2 rounded-full text-[10px] md:text-xs font-bold uppercase tracking-widest mb-6 inline-block shadow-[0_0_15px_rgba(0,245,212,0.3)]">
                                Pop Sensation
                            </span>
                            <motion.h1 
                                whileHover={{ skewX: -5 }}
                                className="text-6xl md:text-8xl lg:text-[8rem] font-black italic tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-[#00F5D4]/70 drop-shadow-[0_10px_20px_rgba(0,0,0,0.8)] cursor-default uppercase leading-none"
                            >
                                {artist.artistName}
                            </motion.h1>
                        </div>
            ...
            <motion.div 
                ...
                className="relative z-20 mt-16 flex flex-col md:flex-row items-center justify-between gap-8 w-full max-w-6xl bg-[#1A1C23]/60 backdrop-blur-2xl p-8 md:px-12 rounded-[2rem] border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
            >
                ...
                <motion.button 
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="bg-gradient-to-r from-[#FF007F] to-[#00F5D4] text-[#110E1B] px-12 py-4 rounded-full font-black tracking-widest uppercase text-sm md:text-base shadow-[0_10px_30px_rgba(0,245,212,0.4)] border border-white/20 hover:border-white transition-all"
                >
                    Get Tickets
                </motion.button>
            </motion.div>
