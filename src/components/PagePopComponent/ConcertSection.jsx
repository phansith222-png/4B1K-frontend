            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <Reveal effect="fade-up">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 border-b border-white/10 pb-6">
                        ...
                        <button onClick={() => window.open('https://www.thaiticketmajor.com/', '_blank')} className="flex items-center gap-2 text-xs font-bold text-gray-400 hover:text-white transition-colors group bg-[#1A1C23] px-6 py-3 rounded-full border border-white/10 shadow-lg mt-4 md:mt-0">
                            View All Dates
