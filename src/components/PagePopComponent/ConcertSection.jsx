        ...
        <section className="relative w-full py-24 px-6 bg-transparent border-t border-white/5">
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 border-b border-white/10 pb-6">
                    ...
                    <button className="flex items-center gap-2 text-xs font-bold text-gray-400 hover:text-white transition-colors group bg-[#1A1C23] px-6 py-3 rounded-full border border-white/10 shadow-lg mt-4 md:mt-0">
                        View All Dates
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                    {events.slice(0, 4).map((item, idx) => {
                        ...
                        return (
                        <div key={idx} className="relative rounded-[2.5rem] overflow-hidden group border border-white/10 hover:border-[#00F5D4]/50 transition-all duration-500 cursor-pointer bg-[#1A1C23] shadow-[0_15px_30px_rgba(0,0,0,0.5)]">
