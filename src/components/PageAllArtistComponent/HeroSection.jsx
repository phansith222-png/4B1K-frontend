        ...
        <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="max-w-7xl w-full mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center justify-between gap-16 mt-20 md:mt-0">
                ...
                <div className="w-full md:w-1/2 flex justify-center md:justify-end relative h-[450px] md:h-[650px]">
                    ...
                    >
                        <div className="w-[280px] h-[280px] md:w-[480px] md:h-[480px] hero-vinyl relative rounded-full flex items-center justify-center">
                    ...
                    <AnimatePresence mode="wait">
                        {spotlightArtist && (
                            <motion.div
                                ...
                                className="absolute bottom-10 right-0 md:right-10 z-30 bg-[#12141A]/90 backdrop-blur-2xl border border-white/10 p-5 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] w-[240px] md:w-[280px] group cursor-pointer"
                                onClick={() => {
                            ...
                            >
                                ...
                                <div className="relative aspect-square rounded-2xl overflow-hidden mb-4 bg-[#0B0C10]">
                                    <img 
                                        src={spotlightArtist.profileImage || "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?q=80&w=800"} 
