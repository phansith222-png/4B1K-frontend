...
export default function PageRock() {
    ...
    return (
        <div className="bg-[#050505] min-h-screen text-[#FFFFFF] font-sans overflow-x-hidden selection:bg-[#D3131F] selection:text-white">
            ...
            {loading ? (
                <div className="min-h-screen flex flex-col items-center justify-center text-[#D3131F] relative overflow-hidden">
                ...
                <>
                    ...
                    <style>{`
                        ...
                        @keyframes floatRock { 0%, 100% { transform: translate(0, 0) scale(1) rotate(0deg); } 33% { transform: translate(40px, -60px) scale(1.1) rotate(5deg); } 66% { transform: translate(-30px, 30px) scale(0.9) rotate(-5deg); } }
                        .bar-spotify-v3 { background: linear-gradient(180deg, #6b7280 0%, #374151 100%); border-radius: 6px 6px 0 0; box-shadow: inset 1px 1px 2px rgba(255,255,255,0.2), inset -1px 0 2px rgba(0,0,0,0.8); transition: all 0.3s ease; }
                        .bar-youtube-v3 { background: linear-gradient(180deg, #ef4444 0%, #b91c1c 100%); border-radius: 6px 6px 0 0; box-shadow: inset 1px 1px 2px rgba(255,255,255,0.4), inset -1px 0 2px rgba(0,0,0,0.6), 0px 10px 20px rgba(211,19,31,0.2); transition: all 0.3s ease; }
